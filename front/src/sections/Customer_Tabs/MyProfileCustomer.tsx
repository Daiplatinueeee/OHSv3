...
import imageFallback from "@/assets/1-removebg-preview.png"
          ...
          <div className="bg-white rounded-3xl p-6">
            ...
            {isEditingDetails ? (
              <form onSubmit={handleSaveDetails} className="grid grid-cols-1 gap-6">
                ...
                <div className="h-0.5 w-full mt-5 mb-5 rounded-full bg-gray-200"></div>
                      ...
                      >
                        {frontIdPreview ? (
                          <div className="w-full">
                            ...
                            >
                              <img
                                src={frontIdPreview || imageFallback}
                            ...
                            <button
                              ...
                              onClick={(e) => {
                                e.stopPropagation()
                                handleIdUploadClick(frontIdRef.current)
                              }}
                      ...
                      >
                        {backIdPreview ? (
                          <div className="w-full">
                            ...
                            >
                              <img
                                src={backIdPreview || imageFallback}
                            ...
                            <button
                              ...
                              onClick={(e) => {
                                e.stopPropagation()
                                handleIdUploadClick(backIdRef.current)
                              }}
                              className="w-full px-3 py-2 text-sm font-medium text-blue-600 bg-blue-50 border border-blue-200 rounded-md hover:bg-blue-100 hover:border-blue-300 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-1"
                            >
                              Change Back ID
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-2">
                    <div>
                      ...
                      {userDetails?.idDocuments?.front ? (
                        ...
                        >
                          <img
                            src={userDetails.idDocuments.front || imageFallback}
                    ...
                    <div>
                      ...
                      {userDetails?.idDocuments?.back ? (
                        ...
                        >
                          <img
                            src={userDetails.idDocuments.back || imageFallback}
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto font-['SF_Pro_Display',-apple-system,BlinkMacSystemFont,sans-serif]">
        ...
        <div className="relative h-80 overflow-hidden rounded-b-3xl">
          <img
            src={userDetails?.coverPhoto || imageFallback}
            alt="Cover"
          ...
          <div className="absolute -top-16 left-8">
            <div className="relative">
              <div className="w-32 h-32 rounded-full border-4 border-white overflow-hidden bg-white">
                <img
                  src={userDetails?.profilePicture || imageFallback}
              ...
              <div className="flex flex-col bg-gray-50 p-6 md:w-2/5">
                ...
                <div className="flex flex-col">
                  <div className="relative mb-4 h-48 w-full overflow-hidden rounded-xl border border-gray-300 bg-gray-200">
                    <img
                      src={editedInfo.image || imageFallback}
                      alt="Preview"
