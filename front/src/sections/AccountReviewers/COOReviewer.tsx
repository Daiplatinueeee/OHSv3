              ...
              <div className="bg-white rounded-xl p-6 mb-6 border border-gray-100">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-gray-900">{account.joinDate}</p>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <p className="text-gray-900">11-25 employees</p>
                  </div>
                  <div>
                ...
                <div className="mt-6">
                  ...
                  <p className="text-gray-900">
                    This service provider offers high-quality services with a commitment to customer satisfaction. They
                    are dedicated to delivering excellent results and building long-term relationships with their
                    clients.
                  </p>
                </div>
              </div>
